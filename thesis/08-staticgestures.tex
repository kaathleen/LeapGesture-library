...
\end{equation}
where $l_{ik}$ is the probability measure of belonging of $i$-th data to the $k$-th class.
...
\begin{center}
    ...
    1,2,4				& 75.4\% & 87.3\%  & 78.4\% & 90.6\% \\ \hline
    1,3,5              	& 76.3\% & 87.5\%  & 79.6\% & 91.5\% \\ \hline
    1,3,4,5            	& 78.1\% & 87.5\%  & 79.6\% & 91.5\% \\ \hline
    1,2,3,4,5           & 83.2\% & 90.3\%  & 85.8\% & 93.0\% \\ \hline
    1,2b,3,4,5          & 76.6\% & 87.6\%  & 79.8\% & 91.6\% \\ \hline
    \end{tabular}
    \end{center}
\end{table}
