...
% Authors here.
\author{%
   Katarzyna Zjawin \album{98826} \and 
   Michał Nowicki \album{95883} \and 
   Olgierd Pilarczyk \album{xxx} \and 
   Jakub Wąsikowski \album{101560}}
...
\input{05-introductiongesturerecognition.tex}
\input{07-gesturerecognitionforlm.tex}
\input{05-introductiongesturerecognition.tex}
\input{08-staticgestures.tex}
\input{09-dynamic-gestures.tex}
\input{10-librarydedicatedforlmc.tex}
\input{11-conclusions.tex}
